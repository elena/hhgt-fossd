...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.header'
        db.add_column(u'slides_slide', 'header',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.header'
        db.delete_column(u'slides_slide', 'header')
    ...
    models = {
        ...
        u'slides.slide': {
            ...
            'header': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
