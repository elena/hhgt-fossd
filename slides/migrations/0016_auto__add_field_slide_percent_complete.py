...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.percent_complete'
        db.add_column(u'slides_slide', 'percent_complete',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.percent_complete'
        db.delete_column(u'slides_slide', 'percent_complete')
