...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.helper'
        db.add_column(u'slides_slide', 'helper',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.helper'
        db.delete_column(u'slides_slide', 'helper')
    ...
    models = {
        ...
        u'slides.slide': {
            ...
            'helper': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
